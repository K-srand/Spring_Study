...
<!--헤더파일 들어가는 곳 시작 -->
  <header>
    <!--로고 들어가는 곳 시작--->  
    <div id="logo">
      <a href="NonageShop?command=index">
    ...
    <nav id="catagory_menu">
     <ul>
       ...
       <li>         
         <a href="NonageShop?command=login_form" style="width:110px;">LOGIN(CUSTOMER</a>   
	     <a href="NonageShop?command=admin_login_form" style="width:100px;">| ADMIN)</a>
	   </li>		       
       <li>/</li>
       <li><a href="NonageShop?command=contract">JOIN</a></li>
       </c:when>
       <c:otherwise>
       <li style="color:orange">
         ${sessionScope.loginUser.name}(${sessionScope.loginUser.id})
       </li>
       <li><a href="NonageShop?command=logout">LOGOUT</a></li>
       </c:otherwise>       
       </c:choose>
       <li>/</li>
       <li>
         <a href="NonageShop?command=cart_list">CART</a>
       </li><li>/</li>
       <li>
         <a href="NonageShop?command=mypage">MY PAGE</a>
       </li><li>/</li>
       <li>
         <a href="NonageShop?command=qna_list">Q&amp;A(1:1)</a>
       </li>
     </ul>
    </nav>
